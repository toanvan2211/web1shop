...
<body>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="form.php?edit=<?php echo $row["username"] ?>">
    ...
    <div class="box-input">
        <h1 title="">Thông tin người dùng</h1>
        <form action="control.php" method="POST">
            <?php
                if(isset($_GET['edit'])){
                    $username = $_GET['edit'];
                    $sql1 = "select * form nguoidung username = '$username'";
                    $data1 = $connect->query($query);
            ...
            <input type="button" id="btn" value="Create" name="save" onclick="loiphone()">
